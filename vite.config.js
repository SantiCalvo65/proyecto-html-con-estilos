  ...
  build: {
    rollupOptions: {
      input: {
        ...
        curso_1: resolve(__dirname, "./cursos/Curso_1.html"),
        curso_2: resolve(__dirname, "./cursos/Curso_2.html"),
        Blog: resolve(__dirname, "./Noticias.html"),
        Blog_1: resolve(__dirname, "./noticias/Noticias_1.html"),
        Blog_2: resolve(__dirname, "./noticias/Noticias_2.html"),
